...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.62\linewidth]{seq_len_histogram.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{dataset_examples.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\linewidth]{lr_sweep.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.96\linewidth]{sp_training_curves.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\linewidth]{mup_lr_sweep.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\linewidth]{sp_vs_mup_scaling.png}
...
where $d_\text{base} = 64$ is the base model width. For our nominal LR
$= 10^{-2}$:
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\linewidth]{large_extended_training_curve.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{generated_grid.png}
